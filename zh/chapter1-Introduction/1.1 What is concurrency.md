...
![并发与并行的区别](https://github.com/forhappy/A-Detailed-Cplusplus-Concurrency-Tutorial/blob/master/images/chapter1/concurrent-vs-parallel.png)

直观来讲，并发意味着多个执行实体可能需要竞争资源，因此就不可避免带来竞争和同步的问题；而并行则是不同的执行实体拥有各自的资源，相互之间可能互不干扰。
